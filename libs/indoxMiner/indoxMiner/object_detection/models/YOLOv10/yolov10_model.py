...
class YOLOv10Model:
    def __init__(self, model_path="yolo10n.pt", device="cuda"):
        """
        Initialize YOLOv10 model.
        Args:
            model_path (str): Path to YOLOv10 model weights (e.g., 'yolo10n.pt').
    ...
    def detect_objects(self, image_path, conf_threshold=0.25, save_dir="./runs/detect"):
        """
        Perform object detection using YOLOv10 CLI.
        Args:
    ...
    def visualize_results(self, result_image_path):
        ...
        Args:
            result_image_path (str): Path to the output image saved by YOLOv10.
        """

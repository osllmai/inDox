...
The base vector store class `VectorStoreBase` defines the interface for
vector-based document stores. It includes abstract methods for adding
documents and retrieving documents similar to a given query.
...
Users should configure their vector store in a YAML file or set it

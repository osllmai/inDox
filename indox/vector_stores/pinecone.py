...
from typing import TYPE_CHECKING, Any, Callable, Iterable, List, Optional, Tuple, Union, Type, TypeVar,Iterator, ClassVar
from indox.vector_stores.utils import DistanceStrategy, maximal_marginal_relevance
...
class PineconeVectorStore():
 ...
 and optimize using HTTP based embeddings.
 ...
 to add to the vectorstore.
    ...
    def add_document(self, documents: List[Document], **kwargs: Any) -> list[str]:
        ...
        return self.db.add_texts(texts, metadatas, **kwargs)

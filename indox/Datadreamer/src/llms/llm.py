...
def _check_max_new_tokens_possible(
    ...
    max_context_length = self.get_max_context_length(prompts, max_new_tokens=0)
    max_output_length = self._get_max_output_length()
    max_new_tokens_possible = self.get_max_context_length(
        prompts, max_new_tokens=max_prompt_length
    )

    print(f"Max Prompt Length: {max_prompt_length}")
    print(f"Max Context Length: {max_context_length}")
    print(f"Max Output Length: {max_output_length}")
    print(f"Max New Tokens Possible: {max_new_tokens_possible}")

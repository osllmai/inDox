...
class GroundingDINOModel:
    def __init__(
        ...
        Args:
            ...
            model_weights_path (str): Path to the model weights file.
            device (str): Device to run the model on ('cuda' or 'cpu').
            box_threshold (float): Confidence threshold for detecting bounding boxes.
            text_threshold (float): Confidence threshold for matching text prompts.
        """
        self.device = device
        self.model = load_model(config_path, model_weights_path)
        self.model.to(self.device).eval()
    ...
    def detect_objects(self, image_path: str, text_prompt: str):
        """
        Detects objects in the image using the specified text prompt.

        Args:
            image_path (str): Path to the input image file.
            text_prompt (str): Comma-separated text prompt to guide object detection
        ...
        Returns:
            dict: A dictionary containing:
                ...
                - 'phrases': Corresponding text phrases for detected objects.
        """
        image_source, image = load_image(image_path)
    ...
    def visualize_results(self, result: dict):
        """
        Visualizes the object detection results on the image.
        ...
        # Annotate the image with detected boxes and phrases
